...
public class Juego {
	...
	private IMostrar _imostrar; // Actividad 2 pla3
	...
	public String jugar() {
		...
		mostrar(jugador1.getNombre() + " elige " + jugador1.getJugada());
		//System.out.println(jugador2.getNombre() + " elige " + jugador2.getJugada());
		mostrar(jugador2.getNombre() + " elige " + jugador2.getJugada());
